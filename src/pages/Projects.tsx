        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-white">
            ...
            <p className="text-xl opacity-90">
              <span className="text-solar-300">Home</span> / Projects
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            {projects.map((project, index) => (
              <Card 
                key={index} 
                className={`overflow-hidden shadow-elegant hover:shadow-glow transition-all duration-300 group cursor-pointer ${
                  project.featured ? 'bg-gradient-solar text-white' : 'bg-background'
                }`}
              >
                ...
                <div className="p-6">
                  <h3 className={`text-xl font-bold mb-4 ${project.featured ? 'text-white' : 'text-foreground'}`}>
                    {project.title}
                  </h3>
                  <p className={`leading-relaxed ${project.featured ? 'text-white/90' : 'text-muted-foreground'}`}>
                    {project.description}
                  </p>
                </div>
              </Card>
